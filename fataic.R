...
fataic<-DO(physio, "FatScore", constant = "+newlifespan+newstat+avg_invert+
           CatchTime_mins+s(birthyear, bs='re')+s(Observer, bs='re')", family=poisson)

saveRDS(fataic, "fataic.rds")