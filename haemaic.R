...
haemaic<-DO(haematocrit, 'Cells_z', constant = '+newlifespan+newstat+avg_invert+
            CatchTime_mins+s(birthyear, bs="re")+s(Observer, bs="re")',family=gaussian)

saveRDS(haemaic,"haemaic.rds")