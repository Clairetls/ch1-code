...
#######
wingaic<-DO(physio,"WingLength_z", constant = "+newlifespan+RightTarsus_z+newstat+
            avg_invert+s(birthyear, bs='re')+s(Observer, bs='re')", family=gaussian)

saveRDS(wingaic, "wingaic.rds")
