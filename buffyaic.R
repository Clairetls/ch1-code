...
haematocrit$age_year<-haematocrit$age
...
buffyaic<-DO(haematocrit,'wbc_z',constant="+newlifespan+newstat+avg_invert+CatchTime_mins+
             s(birthyear, bs='re')+s(Observer, bs='re')",family=gaussian)

saveRDS(buffyaic, "buffyaic.rds")
